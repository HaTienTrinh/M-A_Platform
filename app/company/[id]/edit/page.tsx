...
export default function EditCompanyPage() {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (data) {
          reset({
            ...
            founder_pct: data.founder_pct || 0,
            investor_pct: data.investor_pct || 0,
            esop_pct: data.esop_pct || 0,
          })
        }
      } catch (error: any) {
    ...
    fetchCompany()
  }, [companyId, supabase, reset, router])
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              {step === 1 && 'Update your company legal details'}
              {step === 2 && 'Update your business operations'}
              {step === 3 && 'Update your ownership structure'}
            </CardDescription>
          </CardHeader>
          <CardContent>
